...
const Footer = () => {
  return (
    <>
        <div className='my-10 max-lg:h-[25rem] max-lg:grid-cols-3 max-lg:grid-rows-12 max-sm:grid-cols-2 max-sm:grid-rows-12 grid-flow-col max-sm:h-[28rem] h-60 gap-5 grid grid-cols-4 grid-rows-5'>
            <div className='text-sm row-span-3 max-lg:row-span-4 max-sm:row-span-3'>
            ...
            <div className='row-span-2 max-lg:row-span-4 max-sm:row-span-3'>
            <h1 className="text-lg mb-3">Payment</h1>
            <img className="w-1/4 mr-2 rounded-md h-1/2 max-lg:h-1/3 inline" src={kbzpay} alt="" />
            <img className="w-1/4 max-lg:h-1/3 h-1/2 rounded-md inline" src={wave} alt="" />
            </div>
            ...
            <div className='row-span-2 max-lg:row-span-3 max-sm:row-span-2'>
            ...
            <div className='row-span-3 max-lg:row-span-8 max-sm:row-span-6'>
