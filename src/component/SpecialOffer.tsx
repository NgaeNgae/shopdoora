...
const SpecialOffer = () => {
  return (
    <>
        <div className='grid text-white h-[22rem] max-sm:h-[60rem] max-sm:grid-rows-7 max-sm:gap-y-2 gap-x-2 my-5 grid-cols-5 max-sm:grid-cols-6 grid-rows-2 grid-flow-col'>
        <section style={{backgroundImage: `url(${offerBackground})`}} className="col-span-3 bg-left rounded-md flex max-sm:col-span-6 items-end row-span-3">
            ...
            <h2 className='w-2/3 my-3'>Be a Vape Pi member and get our special exclusive offers</h2>
            <button className='px-6 rounded-full py-1 bg-gray-900/50'>View</button>
            </div>
        </section>
        <div className=' max-sm:col-span-3 max-sm:row-span-4 relative rounded-md col-span-1 row-span-3'>
            ...
            <section className='absolute backdrop-blur-sm bg-opacity-40 bg-black rounded-b-md w-full flex justify-between bottom-0 p-2'>
                <div className='w-2/3'>
