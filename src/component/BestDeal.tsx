...
const BestDeal = () => {
  ...
  return (
    <>
        ...
        <div className="flex max-lg:flex-wrap max-sm:block my-5 justify-around">
            {
                pods.map((pod,index) => {
                    return (
                        <section key={index} className='transform max-lg:my-5 active:scale-90 max-lg:w-[32%] transition-transform w-[16%] max-sm:my-10 max-sm:gap-6 max-sm:w-[100%] relative text-center'>
        ...
        <div className="flex flex-col max-lg:mb-20 items-center">
